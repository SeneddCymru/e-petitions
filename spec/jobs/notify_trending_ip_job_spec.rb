...
RSpec.describe NotifyTrendingIpJob, type: :job do
  ...
  it "sends a notification to the Slack channel" do
    ...
    message << "from <https://moderate.petitions.parliament.scot/admin/petitions/#{'PE%04d' % petition.pe_number_id}/signatures?q=127.0.0.1&window=2019-03-31T16%3A00%3A00Z|127.0.0.1>"
