...
RSpec.describe NotifyTrendingDomainJob, type: :job do
  ...
  it "sends a notification to the Slack channel" do
    ...
    message << "<https://moderate.petitions.parliament.scot/admin/petitions/#{'PE%04d' % petition.pe_number_id}|Do Stuff!> "
    message << "from <https://moderate.petitions.parliament.scot/admin/petitions/#{'PE%04d' % petition.pe_number_id}/signatures?q=%40example.com&window=2019-03-31T16%3A00%3A00Z|example.com>"
