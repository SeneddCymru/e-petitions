...
RSpec.describe DebateOutcome, type: :model do
  ...
  describe "validations" do
    ...
    it { is_expected.to validate_length_of(:transcript_url_gd).is_at_most(500) }
    it { is_expected.to validate_length_of(:video_url_gd).is_at_most(500) }
    it { is_expected.to validate_length_of(:debate_pack_url_gd).is_at_most(500) }

    it { is_expected.to allow_value("https://www.example.com/").for(:debate_pack_url_en) }
    it { is_expected.to allow_value("https://www.example.com/").for(:debate_pack_url_gd) }
    it { is_expected.to allow_value("https://www.example.com/").for(:transcript_url_en) }
    it { is_expected.to allow_value("https://www.example.com/").for(:transcript_url_gd) }
    it { is_expected.to allow_value("https://www.example.com/").for(:video_url_en) }
    it { is_expected.to allow_value("https://www.example.com/").for(:video_url_gd) }

    it { is_expected.to allow_value("http://www.example.com/").for(:debate_pack_url_en) }
    it { is_expected.to allow_value("http://www.example.com/").for(:debate_pack_url_gd) }
    it { is_expected.to allow_value("http://www.example.com/").for(:transcript_url_en) }
    it { is_expected.to allow_value("http://www.example.com/").for(:transcript_url_gd) }
    it { is_expected.to allow_value("http://www.example.com/").for(:video_url_en) }
    it { is_expected.to allow_value("http://www.example.com/").for(:video_url_gd) }

    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:debate_pack_url_en) }
    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:debate_pack_url_gd) }
    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:transcript_url_en) }
    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:transcript_url_gd) }
    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:video_url_en) }
    it { is_expected.not_to allow_value("javascript:alert('Hello, World!');").for(:video_url_gd) }
