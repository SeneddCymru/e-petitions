  ...
  context "when logged in as a sysadmin" do
    ...
    describe "PATCH /admin/site" do
      ...
      context "when the params are valid" do
        let :params do
          { title: "Petition the Scottish Parliament" }
        end

        it "redirects to the edit page" do
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/site/edit")
        end
      ...
      context "when submitting just the petitions params" do
        let :params do
          { petition_duration: "4", threshold_for_referral: "50", threshold_for_debate: "5000" }
        end
