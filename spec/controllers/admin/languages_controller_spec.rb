  ...
  context "when logged in as a sysadmin" do
    ...
    describe "PATCH /admin/languages/en-GB/title" do
      context "when the update is successful" do
        before { patch :update, params: { locale: "en-GB", key: "title", translation: "Scottish Petitions" } }
      ...
      context "when the update is unsuccessful" do
        before do
          expect(language).to receive(:set!).with("title", "Scottish Petitions").and_return(false)
        end
    ...
    describe "DELETE /admin/languages/en-GB/title" do
      context "when the deletion is successful" do
        ...
        it "redirects to the show page" do
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/languages/en-GB")
        end
    ...
    describe "POST /admin/languages/en-GB/reload" do
      context "when the reload is successful" do
        ...
        it "redirects to the show page" do
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/languages")
        end
