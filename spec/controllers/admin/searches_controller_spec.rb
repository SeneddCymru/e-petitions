    ...
    describe "GET /admin/search" do
      context "when searching for petitions" do
        it "redirects to the petitions search url" do
          get :show, params: { type: "petition", q: "foo" }
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/petitions?q=foo")
        end
      end
      ...
      context "when searching for petitions with tags" do
        it "redirects to the petitions search url" do
          ...
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/petitions?match=any&q=foo&tags%5B%5D=1")
        end
      end
      ...
      context "when searching for petitions with no tags" do
        it "redirects to the petitions search url" do
          ...
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/petitions?match=none&q=foo")
        end
      end
      ...
      context "when searching for signatures" do
        it "redirects to the signatures search url" do
          ...
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/signatures?q=foo")
        end
      end
      ...
      context "when searching for signatures in a time period" do
        it "redirects to the signatures search url" do
          ...
          expect(response).to redirect_to("https://moderate.petitions.parliament.scot/admin/signatures?q=foo&window=300")
        end
      end
