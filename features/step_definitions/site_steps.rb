...
Given(/^petitions are not collecting signatures$/) do
  ...
  home_page_message = <<~MESSAGE
    ...
    Whilst the Scottish Parliament elections are taking place we have paused the collecting of signatures on petitions.

    For further information please see [the Scottish Parliament web site][1].

    [1]: https://parliament.scot/
  MESSAGE
