Feature: Suzy Singer searches by free text
  ...
  Background:
    ...
    And an open petition exists with action_en: "Uncle Bulgaria", additional_details_en: "The Wombles are here", action_gd: "Uncle Bulgaria", additional_details_gd: "Tha na Wombles an seo", referred_at: "1 day ago"
    And an open petition exists with action_en: "Common People", background: "The Wombles belong to us all", action_gd: "Daoine Cumanta", background_gd: "Buinidh na Wombles dhuinn uile", referred_at: "1 day ago"
  ...
  Scenario: See search counts
    ...
    And I press "Search"
    Then I should see a "under consideration" petition count of 5

  Scenario: Search for open petitions using multiple search terms
    When I search for "Under consideration" with "overthrow the"
  ...
  Scenario: Paginate through open petitions
    ...
    When I search for "Under consideration" with "International"
    And I follow "Next"
